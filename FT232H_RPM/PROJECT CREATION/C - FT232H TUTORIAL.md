...
# RUBY RPM: FT232H → macOS: Real-Time RPM from Castle ESC (No Python)
...
## Read the ESC & (optional) update firmware
...
## Verify the output (quick sanity)
