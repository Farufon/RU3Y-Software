...
# 3) Launch **two Terminal windows** automatically (macOS)
...
# 4) Sanity checks for dual-board use
...
# 6 (Optional, more robust) Select by **USB serial number**
