...
**Austin now measures 446 W per nacelle in hover at 1800 rpm**, against a prediction of
274 W. That is a factor of 1.63, and it implies a figure of merit of 0.43 where the model
...
Expect your captured points to sit well above the BEMT curves on the `live.py` overlay.
That gap is the result, not a fault in the rig.
