...
**Both studs must be properly made up and tight.** They are not just holding the stack
together; they are the tension path. Nacelle dead weight presses down on the cell, rotor
thrust pulls up on it, and the cell reads straight through zero between the two. If a stud
is loose, or if anything in the stack merely rests rather than bolts, you lose every reading
above dead weight, which is most of the range you came here to measure. Doc 05 explains the
sign handling that follows from this.
