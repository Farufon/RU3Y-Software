...
strip chart, the calibration controls, and a predicted-power chart with your
 ...
 *{box-sizing:border-box}
 ...
 canvas{width:100%;display:block;border-radius:6px;background:#0f1116}
...
<div class="grid">
  ...
  <div class="card">
    ...
    <canvas id="strip" height="230"></canvas>
...
<div class="grid" style="margin-top:14px">
  <div class="card">
    <h2>Electrical watts vs thrust &mdash; predicted, R = 457 mm</h2>
    <canvas id="power" height="300"></canvas>
...
const COL=['#6aa9ff','#4ec9a0','#e0a458','#c58ae0','#e05a5a'];
...
def main():
    ...
    if args.bind == "0.0.0.0":
        print(f"          or http://<this-mac-vpn-address>:{args.http_port} from an iPad")
