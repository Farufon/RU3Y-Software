...
| `Port busy` / `Access denied` | Close the Serial Monitor, close `bench.py`, quit any stray `screen` session, then upload |
...
10 Hz with no code change. See `docs/04-wiring.md`.
