...
- **Range.** You need to reach at least 18 degrees at 0.75R to find the thrust ceiling at
  1600 rpm. Confirm you have it before you build the test matrix. If you also want the
  torque stand to reach cruise torque (1.39 N·m at 1000 rpm) the head needs pitch well past
  22 degrees, in deep stall; note the mechanical limit while the gauge is on.
