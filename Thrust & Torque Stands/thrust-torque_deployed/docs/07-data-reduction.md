...
| Check | Expected |
|---|---|
| OGE watts at 7.5 lbf, 1800 rpm | **About 446 W** per nacelle. That is Austin's flight-test figure and the anchor for the whole campaign. The BEMT says 274; it is known to be wrong by 1.6 at this point. See doc 01. |
| Monotonicity | Watts should rise smoothly with height and flatten past z/R = 2 |
| Collective at hover | The model says 16 deg at 0.75R at 1600 rpm falling to about 10 deg at 2000. With the rotor underperforming the model, expect the real numbers a few degrees higher. Far outside that range, check the doc 05a pitch calibration. |
...
If the 1800 rpm OGE point lands much above 520 W, suspect the pitch calibration, a KV
mismatch, ESC timing, or a pack sagging under load. If it lands **below about 380 W**, do
not celebrate: recheck the load cell calibration and the height measurement first, because
the flight-test figure is 446 W and a stand that beats the aircraft by 15 percent has
usually got something wrong.

The BEMT prediction of 274 W at 1800 rpm is no longer a sanity bound. It is the thing being
tested. Where the 1.6 factor between model and aircraft lives, rotor or drivetrain, is
answered by the torque stand in doc 14, not by this script.

Cruise, 1000 rpm at 185 W, is a forward-flight condition and will not appear in this data.
Do not try to reduce toward it.
