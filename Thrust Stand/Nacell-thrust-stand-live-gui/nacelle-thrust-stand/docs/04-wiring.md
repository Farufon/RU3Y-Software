...
Swap green and white, or send `f` to the sketch to flip the sign in software. A reversed
...
| Reads but sign inverted | Green and white swapped. Send `f`, or swap them. Harmless. |
