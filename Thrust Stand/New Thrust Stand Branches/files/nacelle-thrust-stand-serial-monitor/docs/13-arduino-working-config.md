...
This is the **serial-monitor branch**: Arduino Serial Monitor, `screen`, or
`bench.py`. The live-readout branch adds `tools/live.py`, a browser dashboard
with a strip chart and a BEMT power overlay.
...
(80 SPS) to get the intended 10 Hz with no code change.
